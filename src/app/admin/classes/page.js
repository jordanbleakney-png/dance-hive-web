        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-3xl mx-4 p-6">
            ...
            <div className="grid md:grid-cols-3 gap-3">
              ...
              <input className="border rounded p-2" placeholder="Style (optional)" value={form.style} onChange={(e) => setForm({ ...form, style: e.target.value })} />
              <input className="border rounded p-2" placeholder="Instructor" value={form.instructor} onChange={(e) => setForm({ ...form, instructor: e.target.value })} />
              <select className="border rounded p-2" value={form.day} onChange={(e) => setForm({ ...form, day: e.target.value })}>
                {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"].map((d) => (
                  <option key={d} value={d}>{d}</option>
                ))}
              </select>
              <input className="border rounded p-2" placeholder="Time (e.g., 18:00)" value={form.time} onChange={(e) => setForm({ ...form, time: e.target.value })} />
