    ...
    <div className="min-h-screen bg-gray-50 p-6 flex justify-center">
      <div className="bg-white shadow-lg rounded-2xl p-8 w-full max-w-2xl">
        ...
        <p className="text-gray-600 text-center mb-8">
          Fill in your details below to book your child’s free trial lesson.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-gray-700 mb-1">Parent’s Email</label>
            <input
              type="email"
              name="email"
              value={form.email}
          ...
          <div>
            <label className="block text-gray-700 mb-1">Parent’s Phone</label>
            <input
              type="tel"
              name="parentPhone"
